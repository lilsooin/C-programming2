...
namespace codesample.array
{
    internal class InsertStudentInformation3
    {
        public static void InsertStudentInformation3Run() {
            ...
            // Console.WriteLine($"1 {name[0], -20} {studentNumbers[0], -20} {grades[0]}");
        }
    }
}
