...
namespace codesample.logical_and_conditional_operator
{
    internal class OrderOfExpressionEvaluation
    {
        public static void OrderOfExpressionEvaluationRun()
        {
            int num1 = 5;
            int num2 = 15;
            int num3 = 2;
            ...
            int result1 = num1 * num2 + num2 + num2 + num2 - num3 * num1;
